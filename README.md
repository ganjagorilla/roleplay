...
## V7 accessory image refresh
The latest `accessories.html` uses the V7 accessory images stored in `images/accessories/`. Upload the site contents with the same folder structure to GitHub Pages.
